...
Fr_lt(&expaux[0],&lvar[13],&lvar[((1 * Fr_toInt(&lvar[12])) + 6)]); // line circom 40
while(Fr_isTrue(&expaux[0])){
{
...
Fr_lt(&expaux[0],&lvar[14],&lvar[((1 * Fr_toInt(&lvar[12])) + 9)]); // line circom 41
while(Fr_isTrue(&expaux[0])){
Fr_eq(&expaux[0],&lvar[12],&circuitConstants[5]); // line circom 42
...
Fr_eq(&expaux[0],&lvar[12],&circuitConstants[6]); // line circom 45
if(Fr_isTrue(&expaux[0])){
{
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((12 * Fr_toInt(&lvar[14])) + (1 * Fr_toInt(&lvar[13]))) + 23)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
(*_functionTable[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId])(mySubcomponents[cmp_index_ref],ctx);
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((((12 * Fr_toInt(&lvar[14])) + 6) + (1 * Fr_toInt(&lvar[13]))) + 23)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
(*_functionTable[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId])(mySubcomponents[cmp_index_ref],ctx);
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((16 * Fr_toInt(&lvar[14])) + (1 * Fr_toInt(&lvar[13]))) + 59)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
(*_functionTable[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId])(mySubcomponents[cmp_index_ref],ctx);
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((((16 * Fr_toInt(&lvar[14])) + 8) + (1 * Fr_toInt(&lvar[13]))) + 59)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
(*_functionTable[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId])(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &lvar[14];
// load src
Fr_add(&expaux[0],&lvar[14],&circuitConstants[6]); // line circom 41
// end load src
