...
uint get_main_input_signal_no() {return 94;}

uint get_total_signal_no() {return 286;}

uint get_number_of_components() {return 4;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 286;}
...
// load src
// end load src
Fr_copyn(aux_dest,&signalValues[mySignalStart + 33],33);
}
for (uint i = 0; i < 0; i++){
...
// load src
// end load src
Fr_copyn(aux_dest,&signalValues[mySignalStart + 28],3);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 3];
// load src
// end load src
Fr_copyn(aux_dest,&signalValues[mySignalStart + 31],15);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 18];
// load src
// end load src
Fr_copyn(aux_dest,&signalValues[mySignalStart + 51],5);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 23];
// load src
// end load src
Fr_copyn(aux_dest,&signalValues[mySignalStart + 46],5);
}
for (uint i = 0; i < 0; i++){
uint index_subc = ctx->componentMemory[ctx_index].subcomponents[i];
if (index_subc != 0)release_memory_component(ctx,index_subc);
...
Fr_lt(&expaux[0],&lvar[12],&circuitConstants[2]); // line circom 48
...
Fr_lt(&expaux[0],&lvar[13],&lvar[((1 * Fr_toInt(&lvar[12])) + 9)]); // line circom 50
while(Fr_isTrue(&expaux[0])){
Fr_eq(&expaux[0],&lvar[12],&circuitConstants[4]); // line circom 51
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[13])) + 3)]);
}
...
Fr_lt(&expaux[0],&lvar[14],&circuitConstants[1]); // line circom 53
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
...
{
uint map_index_aux[1];
map_index_aux[0]=Fr_toInt(&lvar[14]);
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((5 + (4 * Fr_toInt(&lvar[13]))) + (1 * Fr_toInt(&lvar[14]))) + 3)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
(*_functionTable[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId])(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &lvar[14];
// load src
Fr_add(&expaux[0],&lvar[14],&circuitConstants[5]); // line circom 53
// end load src
...
Fr_eq(&expaux[0],&lvar[12],&circuitConstants[5]); // line circom 56
if(Fr_isTrue(&expaux[0])){
{
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[13])) + 36)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
(*_functionTable[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId])(mySubcomponents[cmp_index_ref],ctx);
...
Fr_lt(&expaux[0],&lvar[14],&circuitConstants[3]); // line circom 58
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 1;
{
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((3 + (6 * Fr_toInt(&lvar[13]))) + (1 * Fr_toInt(&lvar[14]))) + 36)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
(*_functionTable[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId])(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &lvar[14];
// load src
Fr_add(&expaux[0],&lvar[14],&circuitConstants[5]); // line circom 58
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[14],&circuitConstants[3]); // line circom 58
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[13])) + 69)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
(*_functionTable[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId])(mySubcomponents[cmp_index_ref],ctx);
...
Fr_lt(&expaux[0],&lvar[14],&circuitConstants[0]); // line circom 63
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 2;
{
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((3 + (5 * Fr_toInt(&lvar[13]))) + (1 * Fr_toInt(&lvar[14]))) + 69)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
(*_functionTable[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId])(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &lvar[14];
// load src
Fr_add(&expaux[0],&lvar[14],&circuitConstants[5]); // line circom 63
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[14],&circuitConstants[0]); // line circom 63
...
PFrElement aux_dest = &lvar[13];
// load src
Fr_add(&expaux[0],&lvar[13],&circuitConstants[5]); // line circom 50
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[13],&lvar[((1 * Fr_toInt(&lvar[12])) + 9)]); // line circom 50
...
Fr_lt(&expaux[0],&lvar[13],&lvar[((1 * Fr_toInt(&lvar[12])) + 6)]); // line circom 68
while(Fr_isTrue(&expaux[0])){
Fr_eq(&expaux[0],&lvar[12],&circuitConstants[4]); // line circom 69
if(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((25 + (1 * Fr_toInt(&lvar[13]))) + 3)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
(*_functionTable[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId])(mySubcomponents[cmp_index_ref],ctx);
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((29 + (1 * Fr_toInt(&lvar[13]))) + 3)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
(*_functionTable[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId])(mySubcomponents[cmp_index_ref],ctx);
...
Fr_eq(&expaux[0],&lvar[12],&circuitConstants[5]); // line circom 72
if(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 1;
{
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((21 + (1 * Fr_toInt(&lvar[13]))) + 36)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
(*_functionTable[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId])(mySubcomponents[cmp_index_ref],ctx);
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((27 + (1 * Fr_toInt(&lvar[13]))) + 36)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
(*_functionTable[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId])(mySubcomponents[cmp_index_ref],ctx);
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((18 + (1 * Fr_toInt(&lvar[13]))) + 69)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
(*_functionTable[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId])(mySubcomponents[cmp_index_ref],ctx);
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((23 + (1 * Fr_toInt(&lvar[13]))) + 69)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
(*_functionTable[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId])(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &lvar[13];
// load src
Fr_add(&expaux[0],&lvar[13],&circuitConstants[5]); // line circom 68
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[13],&lvar[((1 * Fr_toInt(&lvar[12])) + 6)]); // line circom 68
...
PFrElement aux_dest = &lvar[12];
// load src
Fr_add(&expaux[0],&lvar[12],&circuitConstants[5]); // line circom 48
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[12],&circuitConstants[2]); // line circom 48
