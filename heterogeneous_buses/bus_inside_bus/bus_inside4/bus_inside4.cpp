...
Fr_lt(&expaux[0],&lvar[20],&lvar[((1 * Fr_toInt(&lvar[18])) + 12)]); // line circom 57
while(Fr_isTrue(&expaux[0])){
Fr_eq(&expaux[0],&lvar[18],&circuitConstants[7]); // line circom 58
...
Fr_lt(&expaux[0],&lvar[21],&circuitConstants[1]); // line circom 60
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
...
PFrElement aux_dest = &lvar[21];
// load src
Fr_add(&expaux[0],&lvar[21],&circuitConstants[8]); // line circom 60
// end load src
...
Fr_eq(&expaux[0],&lvar[18],&circuitConstants[8]); // line circom 63
if(Fr_isTrue(&expaux[0])){
{
...
Fr_lt(&expaux[0],&lvar[21],&circuitConstants[1]); // line circom 65
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 1;
{
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((((25 * Fr_toInt(&lvar[19])) + 7) + (2 * Fr_toInt(&lvar[20]))) + (1 * Fr_toInt(&lvar[21]))) + 135)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
(*_functionTable[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId])(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &lvar[21];
// load src
Fr_add(&expaux[0],&lvar[21],&circuitConstants[8]); // line circom 65
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[21],&circuitConstants[1]); // line circom 65
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((229 * Fr_toInt(&lvar[19])) + (1 * Fr_toInt(&lvar[20]))) + 335)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
(*_functionTable[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId])(mySubcomponents[cmp_index_ref],ctx);
...
Fr_lt(&expaux[0],&lvar[21],&circuitConstants[5]); // line circom 70
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 2;
{
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((((229 * Fr_toInt(&lvar[19])) + 5) + (32 * Fr_toInt(&lvar[20]))) + (1 * Fr_toInt(&lvar[21]))) + 335)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
(*_functionTable[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId])(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &lvar[21];
// load src
Fr_add(&expaux[0],&lvar[21],&circuitConstants[8]); // line circom 70
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[21],&circuitConstants[5]); // line circom 70
...
PFrElement aux_dest = &lvar[20];
// load src
Fr_add(&expaux[0],&lvar[20],&circuitConstants[8]); // line circom 57
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[20],&lvar[((1 * Fr_toInt(&lvar[18])) + 12)]); // line circom 57
...
Fr_lt(&expaux[0],&lvar[20],&lvar[((1 * Fr_toInt(&lvar[18])) + 9)]); // line circom 75
while(Fr_isTrue(&expaux[0])){
{
...
PFrElement aux_dest = &lvar[20];
// load src
Fr_add(&expaux[0],&lvar[20],&circuitConstants[8]); // line circom 75
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[20],&lvar[((1 * Fr_toInt(&lvar[18])) + 9)]); // line circom 75
