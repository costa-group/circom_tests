...
uint get_size_of_witness() {return 88;}
...
// load src
// end load src
Fr_copyn(aux_dest,&signalValues[mySignalStart + 18],6);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 6];
// load src
// end load src
Fr_copyn(aux_dest,&signalValues[mySignalStart + 12],6);
}
for (uint i = 0; i < 0; i++){
uint index_subc = ctx->componentMemory[ctx_index].subcomponents[i];
if (index_subc != 0)release_memory_component(ctx,index_subc);
...
Fr_lt(&expaux[0],&lvar[7],&lvar[((1 * Fr_toInt(&lvar[6])) + 3)]); // line circom 36
while(Fr_isTrue(&expaux[0])){
Fr_eq(&expaux[0],&lvar[6],&circuitConstants[2]); // line circom 37
...
map_accesses_aux[1] = map_index_aux[0]*cur_def->lengths[0]*cur_def->size;
}
}
{
...
// load src
// end load src
Fr_copyn(aux_dest,&signalValues[mySignalStart + ((2 * Fr_toInt(&lvar[7])) + 3)],2);
}
...
// load src
// end load src
Fr_copyn(aux_dest,&signalValues[mySignalStart + ((4 + (2 * Fr_toInt(&lvar[7]))) + 3)],2);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 2)){
(*_functionTable[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId])(mySubcomponents[cmp_index_ref],ctx);
...
Fr_eq(&expaux[0],&lvar[6],&circuitConstants[3]); // line circom 40
if(Fr_isTrue(&expaux[0])){
{
...
// load src
// end load src
Fr_copyn(aux_dest,&signalValues[mySignalStart + ((2 * Fr_toInt(&lvar[7])) + 11)],2);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 2)){
(*_functionTable[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId])(mySubcomponents[cmp_index_ref],ctx);
...
// load src
// end load src
Fr_copyn(aux_dest,&signalValues[mySignalStart + ((6 + (2 * Fr_toInt(&lvar[7]))) + 11)],2);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 2)){
(*_functionTable[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId])(mySubcomponents[cmp_index_ref],ctx);
...
// load src
// end load src
Fr_copyn(aux_dest,&signalValues[mySignalStart + ((2 * Fr_toInt(&lvar[7])) + 23)],2);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 2)){
(*_functionTable[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId])(mySubcomponents[cmp_index_ref],ctx);
...
// load src
// end load src
Fr_copyn(aux_dest,&signalValues[mySignalStart + ((4 + (2 * Fr_toInt(&lvar[7]))) + 23)],2);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 2)){
(*_functionTable[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId])(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &lvar[7];
// load src
Fr_add(&expaux[0],&lvar[7],&circuitConstants[3]); // line circom 36
// end load src
