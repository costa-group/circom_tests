...
Fr_eq(&expaux[0],&lvar[6],&circuitConstants[3]); // line circom 39
if(Fr_isTrue(&expaux[0])){
{
...
Fr_lt(&expaux[0],&lvar[6],&circuitConstants[6]); // line circom 54
while(Fr_isTrue(&expaux[0])){
Fr_eq(&expaux[0],&lvar[6],&circuitConstants[4]); // line circom 56
if(Fr_isTrue(&expaux[0])){
{
...
PFrElement aux_dest = &lvar[6];
// load src
Fr_add(&expaux[0],&lvar[6],&circuitConstants[3]); // line circom 54
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[6],&circuitConstants[6]); // line circom 54
