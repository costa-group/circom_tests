...
// load src
Fr_sub(&expaux[1],&signalValues[mySignalStart + 1],&circuitConstants[5]); // line circom 14
Fr_sub(&expaux[2],&signalValues[mySignalStart + 1],&circuitConstants[3]); // line circom 14
Fr_mul(&expaux[0],&expaux[1],&expaux[2]); // line circom 14
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_sub(&expaux[2],&signalValues[mySignalStart + 1],&circuitConstants[6]); // line circom 15
Fr_mul(&expaux[1],&signalValues[mySignalStart + 3],&expaux[2]); // line circom 15
...
// load src
Fr_sub(&expaux[1],&signalValues[mySignalStart + 2],&circuitConstants[5]); // line circom 19
Fr_sub(&expaux[2],&signalValues[mySignalStart + 2],&circuitConstants[3]); // line circom 19
Fr_mul(&expaux[0],&expaux[1],&expaux[2]); // line circom 19
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_sub(&expaux[2],&signalValues[mySignalStart + 2],&circuitConstants[6]); // line circom 20
Fr_mul(&expaux[1],&signalValues[mySignalStart + 4],&expaux[2]); // line circom 20
Fr_eq(&expaux[0],&expaux[1],&circuitConstants[0]); // line circom 20
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
Fr_sub(&expaux[0],&signalValues[mySignalStart + 5],&circuitConstants[7]); // line circom 33
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// need to run sub component
...
Fr_sub(&expaux[3],&circuitConstants[5],&signalValues[mySignalStart + 8]); // line circom 66
Fr_sub(&expaux[2],&signalValues[mySignalStart + 9],&expaux[3]); // line circom 66
Fr_mul(&expaux[1],&signalValues[mySignalStart + 6],&expaux[2]); // line circom 66
...
Fr_add(&expaux[4],&signalValues[mySignalStart + 8],&circuitConstants[1]); // line circom 67
Fr_sub(&expaux[3],&signalValues[mySignalStart + 9],&expaux[4]); // line circom 67
