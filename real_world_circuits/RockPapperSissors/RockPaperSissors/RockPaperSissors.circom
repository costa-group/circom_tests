...
template RockPaperScissors2() {
  signal input player1; // player1 in [2, 3, 5]
  signal input player2; // player1 in [2, 3, 5]
  ...
  signal player1x2;
  player1x2 <== player1 * player2; // player1x2 in [4, 6, 10, 9, 15, 25]
  ...
  isRockScissors <== isRockScissorsComp.out; // is [0,1]
  ...
  signal isP1Less;
  isP1Less <== isP1LessComp.out; // is [0,1]
