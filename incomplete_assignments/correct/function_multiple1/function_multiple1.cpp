...
Fr_lt(&expaux[0],&lvar[15],&circuitConstants[5]); // line circom 40
...
std::map<int,int> size_store {{1,4},{2,6},{0,2}};
...
Fr_lt(&expaux[0],&lvar[16],&lvar[((1 * Fr_toInt(&lvar[15])) + 0)]); // line circom 48
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[16];
// load src
Fr_add(&expaux[0],&lvar[16],&circuitConstants[4]); // line circom 48
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[16],&lvar[((1 * Fr_toInt(&lvar[15])) + 0)]); // line circom 48
}
Fr_eq(&expaux[0],&lvar[15],&circuitConstants[3]); // line circom 52
if(Fr_isTrue(&expaux[0])){
std::map<int,int> size_store {{1,4},{2,6},{0,2}};
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[0]].templateId].defs[0].offset],&lvar[3]); // line circom 53
index_multiple_eq = 1;
while(index_multiple_eq < 2 && Fr_isTrue(&expaux[0])) {
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[0]].templateId].defs[0].offset] + index_multiple_eq,&lvar[3] + index_multiple_eq); // line circom 53
index_multiple_eq++;
}
...
Fr_eq(&expaux[0],&lvar[15],&circuitConstants[4]); // line circom 55
if(Fr_isTrue(&expaux[0])){
std::map<int,int> size_store {{1,4},{2,6},{0,2}};
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[1]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[1]].templateId].defs[0].offset],&lvar[5]); // line circom 56
index_multiple_eq = 1;
while(index_multiple_eq < 4 && Fr_isTrue(&expaux[0])) {
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[1]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[1]].templateId].defs[0].offset] + index_multiple_eq,&lvar[5] + index_multiple_eq); // line circom 56
index_multiple_eq++;
}
...
Fr_eq(&expaux[0],&lvar[15],&circuitConstants[0]); // line circom 58
if(Fr_isTrue(&expaux[0])){
std::map<int,int> size_store {{1,4},{2,6},{0,2}};
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[2]].templateId].defs[0].offset],&lvar[9]); // line circom 59
index_multiple_eq = 1;
while(index_multiple_eq < 6 && Fr_isTrue(&expaux[0])) {
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[2]].templateId].defs[0].offset] + index_multiple_eq,&lvar[9] + index_multiple_eq); // line circom 59
index_multiple_eq++;
}
...
PFrElement aux_dest = &lvar[15];
// load src
Fr_add(&expaux[0],&lvar[15],&circuitConstants[4]); // line circom 40
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[15],&circuitConstants[5]); // line circom 40
