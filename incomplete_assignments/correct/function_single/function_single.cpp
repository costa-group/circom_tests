...
Fr_lt(&expaux[0],&lvar[8],&circuitConstants[5]); // line circom 22
...
{
char* temp = Fr_element2str(&lvar[((1 * Fr_toInt(&lvar[8])) + 0)]);
printf("%s",temp);
delete [] temp;
}
{
...
Fr_eq(&expaux[0],&lvar[((1 * Fr_toInt(&lvar[8])) + 4)],&lvar[((1 * Fr_toInt(&lvar[8])) + 0)]); // line circom 24
...
PFrElement aux_dest = &lvar[8];
// load src
Fr_add(&expaux[0],&lvar[8],&circuitConstants[1]); // line circom 22
// end load src
...
Fr_lt(&expaux[0],&lvar[8],&circuitConstants[5]); // line circom 30
while(Fr_isTrue(&expaux[0])){
{
printf("Output[");
}
...
Fr_eq(&expaux[0],&lvar[((1 * Fr_toInt(&lvar[8])) + 4)],&lvar[((1 * Fr_toInt(&lvar[8])) + 0)]); // line circom 32
...
PFrElement aux_dest = &lvar[8];
// load src
Fr_add(&expaux[0],&lvar[8],&circuitConstants[1]); // line circom 30
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[8],&circuitConstants[5]); // line circom 30
...
Fr_lt(&expaux[0],&lvar[8],&circuitConstants[5]); // line circom 38
while(Fr_isTrue(&expaux[0])){
Fr_eq(&expaux[0],&circuitConstants[2],&lvar[((1 * Fr_toInt(&lvar[8])) + 0)]); // line circom 40
...
PFrElement aux_dest = &lvar[8];
// load src
Fr_add(&expaux[0],&lvar[8],&circuitConstants[1]); // line circom 38
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[8],&circuitConstants[5]); // line circom 38
