...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 1],&signalValues[mySignalStart + 4]); // line circom 15
// end load src
...
C_1_create(mySignalStart+11,1+ctx_index+1,ctx,new_cmp_name,myId);
