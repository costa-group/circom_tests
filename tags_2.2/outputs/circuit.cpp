...
Fr_eq(&expaux[0],&circuitConstants[0],&circuitConstants[0]); // line circom 13
...
{
char* temp = Fr_element2str(&circuitConstants[1]);
printf("%s",temp);
delete [] temp;
}
{
...
Fr_eq(&expaux[0],&circuitConstants[1],&circuitConstants[1]); // line circom 15
...
PFrElement aux_dest = &lvar[0];
// load src
Fr_add(&expaux[0],&lvar[0],&circuitConstants[4]); // line circom 20
// end load src
...
{
char* temp = Fr_element2str(&circuitConstants[5]);
printf("%s",temp);
delete [] temp;
}
{
...
Fr_eq(&expaux[0],&circuitConstants[5],&circuitConstants[5]); // line circom 24
...
Fr_eq(&expaux[0],&circuitConstants[5],&circuitConstants[5]); // line circom 42
...
Fr_eq(&expaux[0],&circuitConstants[2],&circuitConstants[2]); // line circom 44
...
Fr_eq(&expaux[0],&circuitConstants[1],&circuitConstants[1]); // line circom 46
...
Fr_eq(&expaux[0],&circuitConstants[0],&circuitConstants[0]); // line circom 48
