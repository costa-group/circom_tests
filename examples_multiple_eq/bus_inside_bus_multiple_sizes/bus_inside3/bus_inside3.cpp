...
uint get_main_input_signal_no() {return 40;}

uint get_total_signal_no() {return 133;}

uint get_number_of_components() {return 4;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 133;}
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((4 * Fr_toInt(&lvar[1])) + 12)]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + (((4 * Fr_toInt(&lvar[1])) + 1) + 0)];
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((4 * Fr_toInt(&lvar[1])) + 1) + 12)]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + (((4 * Fr_toInt(&lvar[1])) + 2) + 0)];
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((((4 * Fr_toInt(&lvar[1])) + 2) + 1) + 12)]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + ((((4 * Fr_toInt(&lvar[1])) + 2) + 1) + 0)];
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((4 * Fr_toInt(&lvar[1])) + 2) + 12)]);
}
{
PFrElement aux_dest = &lvar[1];
// load src
Fr_add(&expaux[0],&lvar[1],&circuitConstants[3]); // line circom 28
// end load src
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[4]); // line circom 28
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &signalValues[mySignalStart + ((4 * Fr_toInt(&lvar[1])) + 0)];
// load src
...
Fr_lt(&expaux[0],&lvar[6],&circuitConstants[1]); // line circom 49
while(Fr_isTrue(&expaux[0])){
{{
Fr_eq(&expaux[0],&lvar[6],&circuitConstants[2]); // line circom 51
}}
if(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
std::map<int,int> size_store {{0,8},{2,20},{1,12}};
{
...
// load src
// end load src
Fr_copyn(aux_dest,&signalValues[mySignalStart + 12],std::min(size_store[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId], 8));
}
...
{{
Fr_eq(&expaux[0],&signalValues[mySignalStart + 12],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[0]].templateId].defs[1].offset]); // line circom 53
std::map<int,int> size_eq {{0,8},{2,20},{1,12}};
index_multiple_eq = 1;
while(index_multiple_eq < size_eq[ctx->componentMemory[mySubcomponents[cmp_index_ref_load]].templateId] && Fr_isTrue(&expaux[0])) {
Fr_eq(&expaux[0],&signalValues[mySignalStart + 12] + index_multiple_eq,&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[0]].templateId].defs[1].offset] + index_multiple_eq); // line circom 53
index_multiple_eq++;
}
}}
...
{{
Fr_eq(&expaux[0],&lvar[6],&circuitConstants[3]); // line circom 54
}}
if(Fr_isTrue(&expaux[0])){
{
...
Fr_lt(&expaux[0],&lvar[7],&circuitConstants[1]); // line circom 55
while(Fr_isTrue(&expaux[0])){
{
...
// load src
// end load src
Fr_copyn(aux_dest,&signalValues[mySignalStart + ((4 * Fr_toInt(&lvar[7])) + 20)],4);
}
// run sub component if needed
...
{{
Fr_eq(&expaux[0],&signalValues[mySignalStart + ((4 * Fr_toInt(&lvar[7])) + 20)],&ctx->signalValues[ctx->componentMemory[mySubcomponents[1]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[1]].templateId].defs[1].offset+(Fr_toInt(&lvar[7]))*ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[1]].templateId].defs[1].size]); // line circom 57
index_multiple_eq = 1;
while(index_multiple_eq < 4 && Fr_isTrue(&expaux[0])) {
Fr_eq(&expaux[0],&signalValues[mySignalStart + ((4 * Fr_toInt(&lvar[7])) + 20)] + index_multiple_eq,&ctx->signalValues[ctx->componentMemory[mySubcomponents[1]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[1]].templateId].defs[1].offset+(Fr_toInt(&lvar[7]))*ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[1]].templateId].defs[1].size] + index_multiple_eq); // line circom 57
index_multiple_eq++;
}
}}
...
PFrElement aux_dest = &lvar[7];
// load src
Fr_add(&expaux[0],&lvar[7],&circuitConstants[3]); // line circom 55
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[7],&circuitConstants[1]); // line circom 55
...
// load src
// end load src
Fr_copyn(aux_dest,&signalValues[mySignalStart + 32],std::min(size_store[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId], 20));
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= std::min(size_store[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId], 20))){
(*_functionTable[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId])(mySubcomponents[cmp_index_ref],ctx);
...
{{
Fr_eq(&expaux[0],&signalValues[mySignalStart + 32],&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[2]].templateId].defs[1].offset]); // line circom 61
std::map<int,int> size_eq {{0,8},{2,20},{1,12}};
index_multiple_eq = 1;
while(index_multiple_eq < size_eq[ctx->componentMemory[mySubcomponents[cmp_index_ref_load]].templateId] && Fr_isTrue(&expaux[0])) {
Fr_eq(&expaux[0],&signalValues[mySignalStart + 32] + index_multiple_eq,&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[2]].templateId].defs[1].offset] + index_multiple_eq); // line circom 61
index_multiple_eq++;
}
}}
...
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[6])) + 0);
{{
Fr_eq(&expaux[0],&signalValues[mySignalStart + ((4 * Fr_toInt(&lvar[6])) + 0)],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[6])) + 0)]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[6])) + 0)]].templateId].defs[0].offset+(0)*ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[6])) + 0)]].templateId].defs[0].size]); // line circom 64
index_multiple_eq = 1;
while(index_multiple_eq < 4 && Fr_isTrue(&expaux[0])) {
Fr_eq(&expaux[0],&signalValues[mySignalStart + ((4 * Fr_toInt(&lvar[6])) + 0)] + index_multiple_eq,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[6])) + 0)]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[6])) + 0)]].templateId].defs[0].offset+(0)*ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[6])) + 0)]].templateId].defs[0].size] + index_multiple_eq); // line circom 64
index_multiple_eq++;
}
}}
...
PFrElement aux_dest = &lvar[6];
// load src
Fr_add(&expaux[0],&lvar[6],&circuitConstants[3]); // line circom 49
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[6],&circuitConstants[1]); // line circom 49
