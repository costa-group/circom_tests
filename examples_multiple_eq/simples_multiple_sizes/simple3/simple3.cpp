...
Fr_lt(&expaux[0],&lvar[6],&circuitConstants[3]); // line circom 36
while(Fr_isTrue(&expaux[0])){
{{
Fr_eq(&expaux[0],&lvar[6],&circuitConstants[1]); // line circom 38
}}
...
// load src
// end load src
Fr_copyn(aux_dest,&signalValues[mySignalStart + 6],4);
}
...
{{
Fr_eq(&expaux[0],&signalValues[mySignalStart + 6],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 4]); // line circom 40
index_multiple_eq = 1;
while(index_multiple_eq < 4 && Fr_isTrue(&expaux[0])) {
Fr_eq(&expaux[0],&signalValues[mySignalStart + 6] + index_multiple_eq,&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 4] + index_multiple_eq); // line circom 40
index_multiple_eq++;
}
}}
...
{{
Fr_eq(&expaux[0],&lvar[6],&circuitConstants[2]); // line circom 41
}}
if(Fr_isTrue(&expaux[0])){
{
...
// load src
// end load src
Fr_copyn(aux_dest,&signalValues[mySignalStart + 10],4);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 4)){
A_0_run(mySubcomponents[cmp_index_ref],ctx);
...
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[1]].signalStart + 4],&signalValues[mySignalStart + 10]); // line circom 43
index_multiple_eq = 1;
while(index_multiple_eq < 4 && Fr_isTrue(&expaux[0])) {
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[1]].signalStart + 4] + index_multiple_eq,&signalValues[mySignalStart + 10] + index_multiple_eq); // line circom 43
index_multiple_eq++;
}
}}
...
// load src
// end load src
Fr_copyn(aux_dest,&signalValues[mySignalStart + 14],4);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 4)){
A_0_run(mySubcomponents[cmp_index_ref],ctx);
...
{{
Fr_eq(&expaux[0],&signalValues[mySignalStart + 14],&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + 4]); // line circom 46
index_multiple_eq = 1;
while(index_multiple_eq < 4 && Fr_isTrue(&expaux[0])) {
Fr_eq(&expaux[0],&signalValues[mySignalStart + 14] + index_multiple_eq,&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + 4] + index_multiple_eq); // line circom 46
index_multiple_eq++;
}
}}
...
// end load src
Fr_copyn(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[6])) + 0)]].signalStart + 0],2);
}
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[6])) + 0);
{{
Fr_eq(&expaux[0],&signalValues[mySignalStart + ((2 * Fr_toInt(&lvar[6])) + 0)],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[6])) + 0)]].signalStart + 0]); // line circom 49
index_multiple_eq = 1;
while(index_multiple_eq < 2 && Fr_isTrue(&expaux[0])) {
Fr_eq(&expaux[0],&signalValues[mySignalStart + ((2 * Fr_toInt(&lvar[6])) + 0)] + index_multiple_eq,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[6])) + 0)]].signalStart + 0] + index_multiple_eq); // line circom 49
index_multiple_eq++;
}
}}
