...
cmp_index_ref_load = 0;
{{
Fr_eq(&expaux[0],&signalValues[mySignalStart + (((4 * Fr_toInt(&lvar[13])) + 2) + 3)],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[0]].templateId].defs[1].offset+(Fr_toInt(&lvar[13]))*ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[0]].templateId].defs[1].size+ctx->busInsId2FieldInfo[ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[0]].templateId].defs[1].busId].defs[1].offset]); // line circom 45
...
{{
Fr_eq(&expaux[0],&signalValues[mySignalStart + ((12 * Fr_toInt(&lvar[13])) + 23)],&ctx->signalValues[ctx->componentMemory[mySubcomponents[1]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[1]].templateId].defs[1].offset+(Fr_toInt(&lvar[13]))*ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[1]].templateId].defs[1].size+ctx->busInsId2FieldInfo[ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[1]].templateId].defs[1].busId].defs[0].offset]); // line circom 49
std::map<int,int> size_eq {{2,8},{0,2},{1,6}};
index_multiple_eq = 1;
while(index_multiple_eq < size_eq[ctx->componentMemory[mySubcomponents[cmp_index_ref_load]].templateId] && Fr_isTrue(&expaux[0])) {
Fr_eq(&expaux[0],&signalValues[mySignalStart + ((12 * Fr_toInt(&lvar[13])) + 23)] + index_multiple_eq,&ctx->signalValues[ctx->componentMemory[mySubcomponents[1]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[1]].templateId].defs[1].offset+(Fr_toInt(&lvar[13]))*ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[1]].templateId].defs[1].size+ctx->busInsId2FieldInfo[ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[1]].templateId].defs[1].busId].defs[0].offset] + index_multiple_eq); // line circom 49
index_multiple_eq++;
}
}}
