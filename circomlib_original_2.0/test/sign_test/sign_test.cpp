...
void Sign_2_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Sign_2_run(uint ctx_index,Circom_CalcWit* ctx);
...
uint get_total_signal_no() {return 775;}

uint get_number_of_components() {return 3;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 775;}
...
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[7]); // line circom 31
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
