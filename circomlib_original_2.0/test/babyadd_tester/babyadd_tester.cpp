...
// load src
Fr_mul(&expaux[3],&circuitConstants[0],&signalValues[mySignalStart + 6]); // line circom 48
...
Fr_mul(&expaux[4],&circuitConstants[0],&signalValues[mySignalStart + 6]); // line circom 49
...
BabyAdd_0_create(1,0,ctx,"main",0);
BabyAdd_0_run(0,ctx);
}
