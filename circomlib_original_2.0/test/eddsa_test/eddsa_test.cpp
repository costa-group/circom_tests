...
uint get_main_input_signal_no() {return 848;}

uint get_total_signal_no() {return 46078;}

uint get_number_of_components() {return 3817;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 46078;}
...
ctx->componentMemory[coffset].templateName = "Segment";
ctx->componentMemory[coffset].signalStart = soffset;
ctx->componentMemory[coffset].inputCounter = 194;
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
ctx->componentMemory[coffset].subcomponents = new uint[191]{0};
}
...
uint csoffset = mySignalStart+1089;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "e2m";
Edwards2Montgomery_9_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
...
uint csoffset = mySignalStart+1097;
...
uint csoffset = mySignalStart+525;
uint aux_dimensions[1] = {47};
for (uint i = 0; i < 47; i++) {
std::string new_cmp_name = "doublers1"+ctx->generate_position_array(aux_dimensions, 1, i);
MontgomeryDouble_11_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
...
uint csoffset = mySignalStart+807;
uint aux_dimensions[1] = {47};
for (uint i = 0; i < 47; i++) {
std::string new_cmp_name = "doublers2"+ctx->generate_position_array(aux_dimensions, 1, i);
MontgomeryDouble_11_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
...
uint aux_create = 143;
int aux_cmp_num = 0+ctx_index+1;
uint csoffset = mySignalStart+196;
uint aux_dimensions[1] = {47};
for (uint i = 0; i < 47; i++) {
std::string new_cmp_name = "adders"+ctx->generate_position_array(aux_dimensions, 1, i);
MontgomeryAdd_12_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
...
uint csoffset = mySignalStart+1093;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "m2e";
Montgomery2Edwards_14_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[21]); // line circom 130
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[2];
// load src
...
Fr_sub(&expaux[0],&lvar[1],&circuitConstants[2]); // line circom 141
{
uint cmp_index_ref = ((1 * Fr_toInt(&expaux[0])) + 49);
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_sub(&expaux[0],&lvar[1],&circuitConstants[2]); // line circom 141
...
// load src
Fr_sub(&expaux[0],&lvar[1],&circuitConstants[2]); // line circom 143
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[0])) + 49);
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&expaux[0])) + 49)]].signalStart + 0]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
MontgomeryDouble_11_run(mySubcomponents[cmp_index_ref],ctx);
...
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[0])) + 49);
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&expaux[0])) + 49)]].signalStart + 1]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
MontgomeryDouble_11_run(mySubcomponents[cmp_index_ref],ctx);
...
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&expaux[0])) + 96)]].signalStart + 0]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
Window4_13_run(mySubcomponents[cmp_index_ref],ctx);
...
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[0])) + 96);
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&expaux[0])) + 96)]].signalStart + 1]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
Window4_13_run(mySubcomponents[cmp_index_ref],ctx);
...
Fr_sub(&expaux[0],&lvar[1],&circuitConstants[2]); // line circom 154
{
uint cmp_index_ref = ((1 * Fr_toInt(&expaux[0])) + 143);
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_sub(&expaux[0],&lvar[1],&circuitConstants[6]); // line circom 154
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[0])) + 143);
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&expaux[0])) + 143)]].signalStart + 0]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
MontgomeryAdd_12_run(mySubcomponents[cmp_index_ref],ctx);
...
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[0])) + 143);
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&expaux[0])) + 143)]].signalStart + 1]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
MontgomeryAdd_12_run(mySubcomponents[cmp_index_ref],ctx);
...
cmp_index_ref_load = 189;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[189]].signalStart + 1]);
}
// need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
...
cmp_index_ref_load = 190;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[190]].signalStart + 1]);
}
...
// load src
Fr_mul(&expaux[2],&circuitConstants[23],&signalValues[mySignalStart + 2]); // line circom 42
...
ctx->componentMemory[coffset].signalStart = soffset;
ctx->componentMemory[coffset].inputCounter = 592;
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
...
uint aux_create = 0;
int aux_cmp_num = 2+ctx_index+1;
uint csoffset = mySignalStart+614;
for (uint i = 0; i < 1; i++) {
...
uint csoffset = mySignalStart+12500;
for (uint i = 0; i < 1; i++) {
...
Fr_lt(&expaux[0],&lvar[44],&circuitConstants[17]); // line circom 202
while(Fr_isTrue(&expaux[0])){
{{
Fr_eq(&expaux[0],&lvar[44],&circuitConstants[6]); // line circom 203
}}
if(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[46];
...
// load src
Fr_mul(&expaux[1],&lvar[44],&circuitConstants[48]); // line circom 209
...
Fr_lt(&expaux[0],&lvar[44],&circuitConstants[6]); // line circom 219
while(Fr_isTrue(&expaux[0])){
{{
...
cmp_index_ref_load = 2;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[2]].templateId].defs[0].offset+(0)*ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[2]].templateId].defs[0].size]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
BabyAdd_17_run(mySubcomponents[cmp_index_ref],ctx);
...
cmp_index_ref_load = 2;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[2]].templateId].defs[0].offset+(1)*ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[2]].templateId].defs[0].size]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
BabyAdd_17_run(mySubcomponents[cmp_index_ref],ctx);
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[50]); // line circom 92
while(Fr_isTrue(&expaux[0])){
{
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[53]); // line circom 92
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[1])) + 0);
{
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId].defs[2].offset+map_accesses_aux[0]];
// load src
Fr_mul(&expaux[1],&lvar[3],&circuitConstants[49]); // line circom 157
...
// load src
Fr_sub(&expaux[2],&circuitConstants[56],&signalValues[mySignalStart + 258]); // line circom 162
cmp_index_ref_load = 5;
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId].defs[3].offset+map_accesses_aux[0]];
// load src
Fr_sub(&expaux[2],&circuitConstants[57],&signalValues[mySignalStart + 259]); // line circom 163
cmp_index_ref_load = 5;
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[58]); // line circom 166
while(Fr_isTrue(&expaux[0])){
{{
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[59]); // line circom 183
if(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[1])) + 167);
{
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[58]); // line circom 194
while(Fr_isTrue(&expaux[0])){
{{
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId].defs[2].offset+map_accesses_aux[0]];
// load src
Fr_mul(&expaux[1],&lvar[5],&circuitConstants[60]); // line circom 260
...
ctx->componentMemory[coffset].signalStart = soffset;
ctx->componentMemory[coffset].inputCounter = 848;
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
...
uint csoffset = mySignalStart+6536;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "compConstant";
...
uint csoffset = mySignalStart+3699;
for (uint i = 0; i < 1; i++) {
...
{
uint aux_create = 4;
int aux_cmp_num = 3805+ctx_index+1;
uint csoffset = mySignalStart+43244;
for (uint i = 0; i < 1; i++) {
...
uint csoffset = mySignalStart+7055;
for (uint i = 0; i < 1; i++) {
...
uint csoffset = mySignalStart+7069;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "dbl2";
BabyDbl_20_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
...
uint csoffset = mySignalStart+7083;
for (uint i = 0; i < 1; i++) {
...
{
uint aux_create = 8;
int aux_cmp_num = 1812+ctx_index+1;
uint csoffset = mySignalStart+25302;
for (uint i = 0; i < 1; i++) {
...
uint csoffset = mySignalStart+25305;
for (uint i = 0; i < 1; i++) {
...
uint aux_create = 10;
int aux_cmp_num = 0+ctx_index+1;
uint csoffset = mySignalStart+852;
for (uint i = 0; i < 1; i++) {
...
{
uint aux_create = 11;
int aux_cmp_num = 2844+ctx_index+1;
uint csoffset = mySignalStart+33272;
for (uint i = 0; i < 1; i++) {
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 592)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
...
assert(Fr_isTrue(&expaux[0]));
{{
Fr_eq(&expaux[0],&signalValues[mySignalStart + 846],&circuitConstants[1]); // line circom 50
}}
...
assert(Fr_isTrue(&expaux[0]));
{{
Fr_eq(&expaux[0],&signalValues[mySignalStart + 847],&circuitConstants[1]); // line circom 51
}}
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[55]); // line circom 57
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 1;
{
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 80)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
...
{
PFrElement aux_dest = &signalValues[mySignalStart + 848];
// load src
cmp_index_ref_load = 1;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[1]].signalStart + 0]);
...
{
PFrElement aux_dest = &signalValues[mySignalStart + 849];
// load src
cmp_index_ref_load = 1;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[1]].signalStart + 1]);
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[55]); // line circom 67
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 2;
{
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 336)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
Bits2Point_Strict_8_run(mySubcomponents[cmp_index_ref],ctx);
...
{
PFrElement aux_dest = &signalValues[mySignalStart + 850];
// load src
cmp_index_ref_load = 2;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + 0]);
...
{
PFrElement aux_dest = &signalValues[mySignalStart + 851];
// load src
cmp_index_ref_load = 2;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + 1]);
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[55]); // line circom 77
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 3;
{
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[61]); // line circom 81
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 3;
{
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[55]); // line circom 109
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 9;
{
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[55]); // line circom 131
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 11;
{
