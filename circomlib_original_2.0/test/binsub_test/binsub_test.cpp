...
uint get_total_signal_no() {return 104;}

uint get_number_of_components() {return 5;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 104;}
...
PFrElement aux_dest = &lvar[1];
// load src
Fr_pow(&expaux[2],&circuitConstants[4],&lvar[3]); // line circom 55
Fr_mul(&expaux[1],&signalValues[mySignalStart + ((0 + (1 * Fr_toInt(&lvar[3]))) + 16)],&expaux[2]); // line circom 55
Fr_add(&expaux[0],&lvar[1],&expaux[1]); // line circom 55
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &lvar[1];
// load src
Fr_pow(&expaux[2],&circuitConstants[4],&lvar[3]); // line circom 56
Fr_mul(&expaux[1],&signalValues[mySignalStart + ((16 + (1 * Fr_toInt(&lvar[3]))) + 16)],&expaux[2]); // line circom 56
Fr_sub(&expaux[0],&lvar[1],&expaux[1]); // line circom 56
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
Fr_sub(&expaux[2],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[3])) + 0)],&circuitConstants[2]); // line circom 63
Fr_mul(&expaux[1],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[3])) + 0)],&expaux[2]); // line circom 63
{{
...
PFrElement aux_dest = &lvar[2];
// load src
Fr_pow(&expaux[2],&circuitConstants[4],&lvar[3]); // line circom 65
Fr_mul(&expaux[1],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[3])) + 0)],&expaux[2]); // line circom 65
Fr_add(&expaux[0],&lvar[2],&expaux[1]); // line circom 65
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
Fr_sub(&expaux[2],&signalValues[mySignalStart + 48],&circuitConstants[2]); // line circom 69
Fr_mul(&expaux[1],&signalValues[mySignalStart + 48],&expaux[2]); // line circom 69
{{
...
PFrElement aux_dest = &lvar[2];
// load src
Fr_mul(&expaux[1],&signalValues[mySignalStart + 48],&circuitConstants[3]); // line circom 70
Fr_add(&expaux[0],&lvar[2],&expaux[1]); // line circom 70
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{{
...
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((0 + (1 * Fr_toInt(&lvar[0]))) + 16)];
// load src
...
uint cmp_index_ref = 2;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((16 + (1 * Fr_toInt(&lvar[0]))) + 16)];
// load src
