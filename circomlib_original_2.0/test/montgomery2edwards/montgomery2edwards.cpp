...
#include "circom.hpp"
#include "calcwit.hpp"
void Montgomery2Edwards_0_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Montgomery2Edwards_0_run(uint ctx_index,Circom_CalcWit* ctx);
Circom_TemplateFunction _functionTable[1] = { 
Montgomery2Edwards_0_run };
...
Montgomery2Edwards_0_create(1,0,ctx,"main",0);
Montgomery2Edwards_0_run(0,ctx);
}
