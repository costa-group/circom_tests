...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[0]); // line circom 9
...
// load src
Fr_sub(&expaux[1],&lvar[1],&circuitConstants[2]); // line circom 10
Fr_mul(&expaux[0],&signalValues[mySignalStart + ((1 * Fr_toInt(&expaux[1])) + 0)],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 3)]); // line circom 10
// end load src
