...
void MultiAux_1_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void MultiAux_1_run(uint ctx_index,Circom_CalcWit* ctx);
...
void MultiAux_5_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void MultiAux_5_run(uint ctx_index,Circom_CalcWit* ctx);
...
void MultiAux_9_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void MultiAux_9_run(uint ctx_index,Circom_CalcWit* ctx);
...
void Aux_10_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Aux_10_run(uint ctx_index,Circom_CalcWit* ctx);
...
void Aux_12_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Aux_12_run(uint ctx_index,Circom_CalcWit* ctx);
void MultiAux_13_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void MultiAux_13_run(uint ctx_index,Circom_CalcWit* ctx);
...
void Aux_14_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Aux_14_run(uint ctx_index,Circom_CalcWit* ctx);
...
void Aux_16_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Aux_16_run(uint ctx_index,Circom_CalcWit* ctx);
void MultiAux_17_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void MultiAux_17_run(uint ctx_index,Circom_CalcWit* ctx);
...
bool aux_parallel[2] = {false,true};
for (uint i = 0; i < 2; i++) {
bool status_parallel = aux_parallel[i];
std::string new_cmp_name = "c_aux"+ctx->generate_position_array(aux_dimensions, 1, i);
mySubcomponentsParallel[aux_create+i] = status_parallel;
if (status_parallel) Aux_2_create_parallel(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
else Aux_2_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 4 ;
aux_cmp_num += 1;
}
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[2]); // line circom 29
while(Fr_isTrue(&expaux[0])){
{
...
if (mySubcomponentsParallel[cmp_index_ref]){
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
...
bool aux_parallel[3] = {false,true,false};
for (uint i = 0; i < 3; i++) {
bool status_parallel = aux_parallel[i];
std::string new_cmp_name = "c_aux"+ctx->generate_position_array(aux_dimensions, 1, i);
mySubcomponentsParallel[aux_create+i] = status_parallel;
if (status_parallel) Aux_4_create_parallel(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
else Aux_4_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 6 ;
aux_cmp_num += 1;
}
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[3]); // line circom 29
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[1])) + 0);
{
...
bool aux_parallel[4] = {false,true,false,true};
for (uint i = 0; i < 4; i++) {
bool status_parallel = aux_parallel[i];
std::string new_cmp_name = "c_aux"+ctx->generate_position_array(aux_dimensions, 1, i);
mySubcomponentsParallel[aux_create+i] = status_parallel;
if (status_parallel) Aux_6_create_parallel(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
else Aux_6_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 8 ;
aux_cmp_num += 1;
}
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[4]); // line circom 29
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[1])) + 0);
{
...
bool aux_parallel[5] = {false,true,false,true,false};
for (uint i = 0; i < 5; i++) {
bool status_parallel = aux_parallel[i];
std::string new_cmp_name = "c_aux"+ctx->generate_position_array(aux_dimensions, 1, i);
mySubcomponentsParallel[aux_create+i] = status_parallel;
if (status_parallel) Aux_8_create_parallel(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
else Aux_8_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 10 ;
aux_cmp_num += 1;
}
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[5]); // line circom 29
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[1])) + 0);
{
...
bool aux_parallel[6] = {false,true,false,true,false,true};
for (uint i = 0; i < 6; i++) {
bool status_parallel = aux_parallel[i];
std::string new_cmp_name = "c_aux"+ctx->generate_position_array(aux_dimensions, 1, i);
mySubcomponentsParallel[aux_create+i] = status_parallel;
if (status_parallel) Aux_10_create_parallel(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
else Aux_10_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 12 ;
aux_cmp_num += 1;
}
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[6]); // line circom 29
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[1])) + 0);
{
...
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
Aux_10_run(mySubcomponents[cmp_index_ref],ctx);
...
bool aux_parallel[7] = {false,true,false,true,false,true,false};
for (uint i = 0; i < 7; i++) {
bool status_parallel = aux_parallel[i];
std::string new_cmp_name = "c_aux"+ctx->generate_position_array(aux_dimensions, 1, i);
mySubcomponentsParallel[aux_create+i] = status_parallel;
if (status_parallel) Aux_12_create_parallel(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
else Aux_12_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 14 ;
aux_cmp_num += 1;
}
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[7]); // line circom 29
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[1])) + 0);
{
...
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
Aux_12_run(mySubcomponents[cmp_index_ref],ctx);
...
bool aux_parallel[8] = {false,true,false,true,false,true,false,true};
for (uint i = 0; i < 8; i++) {
bool status_parallel = aux_parallel[i];
std::string new_cmp_name = "c_aux"+ctx->generate_position_array(aux_dimensions, 1, i);
mySubcomponentsParallel[aux_create+i] = status_parallel;
if (status_parallel) Aux_14_create_parallel(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
else Aux_14_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 16 ;
aux_cmp_num += 1;
}
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[8]); // line circom 29
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[1])) + 0);
{
...
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
Aux_14_run(mySubcomponents[cmp_index_ref],ctx);
...
bool aux_parallel[9] = {false,true,false,true,false,true,false,true,false};
for (uint i = 0; i < 9; i++) {
bool status_parallel = aux_parallel[i];
std::string new_cmp_name = "c_aux"+ctx->generate_position_array(aux_dimensions, 1, i);
mySubcomponentsParallel[aux_create+i] = status_parallel;
if (status_parallel) Aux_16_create_parallel(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
else Aux_16_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 18 ;
aux_cmp_num += 1;
}
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[9]); // line circom 29
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[1])) + 0);
{
...
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
Aux_16_run(mySubcomponents[cmp_index_ref],ctx);
...
mySubcomponentsParallel[aux_create+i] = false;
MultiAux_1_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 0 ;
aux_cmp_num += 0;
}
...
mySubcomponentsParallel[aux_create+i] = true;
...
mySubcomponentsParallel[aux_create+i] = false;
MultiAux_5_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 0 ;
aux_cmp_num += 0;
}
...
mySubcomponentsParallel[aux_create+i] = false;
MultiAux_9_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 0 ;
aux_cmp_num += 0;
}
...
mySubcomponentsParallel[aux_create+i] = false;
MultiAux_13_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 0 ;
aux_cmp_num += 0;
}
...
mySubcomponentsParallel[aux_create+i] = false;
MultiAux_17_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 0 ;
aux_cmp_num += 0;
}
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[10]); // line circom 46
while(Fr_isTrue(&expaux[0])){
Fr_mod(&expaux[1],&lvar[1],&circuitConstants[2]); // line circom 47
Fr_eq(&expaux[0],&expaux[1],&circuitConstants[1]); // line circom 47
if(Fr_isTrue(&expaux[0])){
...
PFrElement aux_dest = &lvar[1];
// load src
Fr_add(&expaux[0],&lvar[1],&circuitConstants[0]); // line circom 46
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[10]); // line circom 46
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[10]); // line circom 56
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 0)];
// load src
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[1])) + 0);
Fr_sub(&expaux[0],&lvar[1],&circuitConstants[0]); // line circom 57
if (mySubcomponentsParallel[cmp_index_ref]){
{
int aux1 = cmp_index_ref;
