...
void MultiAux_3_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void MultiAux_3_run(uint ctx_index,Circom_CalcWit* ctx);
...
void MultiAux_7_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void MultiAux_7_run(uint ctx_index,Circom_CalcWit* ctx);
...
void MultiAux_11_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void MultiAux_11_run(uint ctx_index,Circom_CalcWit* ctx);
...
void MultiAux_15_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void MultiAux_15_run(uint ctx_index,Circom_CalcWit* ctx);
...
for (uint i = 0; i < 6; i++) {
std::string new_cmp_name = "c_aux"+ctx->generate_position_array(aux_dimensions, 1, i);
Aux_10_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 12 ;
aux_cmp_num += 1;
}
...
for (uint i = 0; i < 7; i++) {
std::string new_cmp_name = "c_aux"+ctx->generate_position_array(aux_dimensions, 1, i);
Aux_12_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 14 ;
aux_cmp_num += 1;
}
...
for (uint i = 0; i < 8; i++) {
std::string new_cmp_name = "c_aux"+ctx->generate_position_array(aux_dimensions, 1, i);
Aux_14_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 16 ;
aux_cmp_num += 1;
}
...
for (uint i = 0; i < 9; i++) {
std::string new_cmp_name = "c_aux"+ctx->generate_position_array(aux_dimensions, 1, i);
Aux_16_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 18 ;
aux_cmp_num += 1;
}
...
MultiAux_3_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 0 ;
aux_cmp_num += 0;
}
...
MultiAux_7_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 0 ;
aux_cmp_num += 0;
}
...
MultiAux_11_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 0 ;
aux_cmp_num += 0;
}
...
MultiAux_15_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 0 ;
aux_cmp_num += 0;
}
