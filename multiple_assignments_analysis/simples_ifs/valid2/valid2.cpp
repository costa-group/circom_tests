...
Fr_gt(&expaux[0],&signalValues[mySignalStart + 2],&circuitConstants[0]); // line circom 8
...
Fr_gt(&expaux[0],&signalValues[mySignalStart + 2],&circuitConstants[2]); // line circom 11
if(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &signalValues[mySignalStart + 0];
// load src
