...
Fr_gt(&expaux[0],&signalValues[mySignalStart + 4],&circuitConstants[0]); // line circom 17
...
Fr_gt(&expaux[0],&signalValues[mySignalStart + 4],&circuitConstants[1]); // line circom 20
if(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &signalValues[mySignalStart + 0];
// load src
// end load src
Fr_copyn(aux_dest,&signalValues[mySignalStart + 7],2);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 2];
// load src
// end load src
Fr_copyn(aux_dest,&signalValues[mySignalStart + 5],2);
}
}else{
{
PFrElement aux_dest = &signalValues[mySignalStart + 0];
